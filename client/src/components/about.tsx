...
import AjayImage from "@/components/Ajay.jpg";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          >
            ...
            <p className="text-base sm:text-lg text-slate-600 mb-4 sm:mb-6 leading-relaxed">
              I'm a curious and hardworking Full Stack Developer who enjoys building web applications that are both useful and easy to use. 
                I like figuring out how things work and turning small ideas into something real with code.
              
              
            </p>
            <p className="text-base sm:text-lg text-slate-600 mb-6 sm:mb-8 leading-relaxed">
              As a recent Computer Science graduate, I've built several full stack projects during my academic journey and internships.I'm still learning every day and always open to new tools, ideas, and challenges that help me grow as a developer.
              
            </p>
            <div className="flex flex-wrap gap-2 sm:gap-4">
              <div className="bg-slate-100 px-4 py-2 rounded-full">
                <span className="text-sm font-medium text-slate-700">Full Stack Developer</span>
              </div>
              <div className="bg-slate-100 px-4 py-2 rounded-full">
                <span className="text-sm font-medium text-slate-700">4+ Projects Completed</span>
              </div>
              <div className="bg-slate-100 px-4 py-2 rounded-full">
                <span className="text-sm font-medium text-slate-700">Open to Opportunities</span>
              </div>
            </div>
          </div>
